...
namespace Projeto_TCC.Alterar
{
    public partial class frmOcorrencias2 : Form
    {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (rbtApto.Checked)
            {
                try
                {
                    ...
                    dataGridView1.DataSource = ocorrenciasDAO.BuscaApto_COD(txtBusca.Text);
            ...
            if (rbtBloco.Checked)
            {
                try
                {
                    ...
                    dataGridView1.DataSource = ocorrenciasDAO.BuscaBloco_COD(txtBusca.Text);
                    for (int i = 0; i == dataGridView1.RowCount; i++)
                    {
                        MessageBox.Show("Nenhuma ocorrência encontrada");
                        txtBusca.Clear();
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtProprietario.Text = linhaSelecionada.Cells[0].Value.ToString();
