...
namespace Projeto_TCC.DAO
{
    class LocacoesDAO
    {
        ...
        public DataTable BuscaData(DateTime inicio)
        {
            ...
            MySqlDataAdapter da;
            comando.CommandText = "select m.nome,  ba.apto, ba.bloco, l.Inicio, l.Termino" +
                             " from MORADORES M, BA BA, LOCACOES L where" +
                             " L.ba_cod = ba.ba_cod AND L.CODMORADOR = M.CODMORADOR AND inicio like @inicio";
            try
            {
        ...
        public DataTable BuscaAptoComCod(string apto)
        {
            ...
            comando.CommandText = "select m.nome,  ba.apto, ba.bloco, l.Inicio, l.Termino, l.codlocacao As CodLocacao" +
                             " from MORADORES M, BA BA, LOCACOES L where" +
                             " L.ba_cod = ba.ba_cod AND L.CODMORADOR = M.CODMORADOR AND apto like @apto";
            try
            {
