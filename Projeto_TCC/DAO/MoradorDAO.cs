...
namespace Projeto_TCC.DAO
{
    class MoradorDAO
    {
        ...
        // BUSCA DE MENOR DE IDADE PELO NOME
        public DataTable BuscaMenor(string nome)
        {
           ...
           comando.CommandText = "select m.nome, m.situacao, m.telefone, m.celular,  ba.apto as apto, ba.bloco as bloco" +
                " from MORADORES M, BA BA where" +
        ...
        // BUSCA DE MENOR DE IDADE PELO APTO
        public DataTable BuscaAptoMenor(string apto)
        {
            MySqlConnection con = ConexaoBanco.Conectar();
            MySqlCommand comando = new MySqlCommand();
            comando.CommandType = CommandType.Text;
        ...
        public DataTable BuscaBlocoMenor(string bloco)
        {
            MySqlConnection con = ConexaoBanco.Conectar();
            MySqlCommand comando = new MySqlCommand();
            comando.CommandType = CommandType.Text;
        ...
        public DataTable BuscaMaior(string nome)
        {
            MySqlConnection con = ConexaoBanco.Conectar();
            MySqlCommand comando = new MySqlCommand();
            comando.CommandType = CommandType.Text;
        ...
        // BUSCA DE MENOR DE IDADE PELO APTO
        public DataTable BuscaAptoMaior(string apto)
        {
            MySqlConnection con = ConexaoBanco.Conectar();
            MySqlCommand comando = new MySqlCommand();
            comando.CommandType = CommandType.Text;
